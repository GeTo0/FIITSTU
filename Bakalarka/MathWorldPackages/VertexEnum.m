...
BeginPackage["MathWorld`VertexEnum`"]
...
Options[PointEnumeration] = {SearchTree -> False, ZeroVariables -> True, MonitoringFile -> "/dev/null"}
...
Options[CSearch] = {SearchTree -> False, NegativeTest-> Function[Negative[Chop[N[Simplify[#]]]]], MonitoringFile->"/dev/null"}
