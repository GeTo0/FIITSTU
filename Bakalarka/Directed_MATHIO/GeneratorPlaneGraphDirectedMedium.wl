...
BeginPackage["GeneratorPlaneGraphDirectedMedium`"]
Equation::usage = "Equation[difficulty] generates a Plane graph problem with solution steps and final result.";
...
(**TVORBA PLANE (LIETADLOV\[CapitalEAcute]HO) GRAFU**)
...
If[diff==="MEDIUM",
n=RandomInteger[{11, 16}];
edgesNumber=RandomInteger[{16, 24}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] Plane (lietadlov\[YAcute]) graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
