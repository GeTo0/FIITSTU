...
BeginPackage["GeneratorCompleteGraphDirectedEasy`"]
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] kompletn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] EASY**)
