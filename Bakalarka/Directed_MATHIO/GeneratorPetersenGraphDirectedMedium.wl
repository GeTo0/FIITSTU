...
BeginPackage["GeneratorPetersenGraphDirectedMedium`"]
Equation::usage = "Equation[difficulty] generates a Petersen graph problem with solution steps and final result.";
...
additionalEdges=RandomSample[missingEdges,5];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] Petersenov graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
