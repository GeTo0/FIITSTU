...
BeginPackage["GeneratorSquareGraphDirectedMedium`"]
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] \[SHacek]tvorcov\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
