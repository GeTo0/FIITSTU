...
BeginPackage["GeneratorBipartiteGraphDirectedEasy`"]
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] bipartitn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] EASY**)
