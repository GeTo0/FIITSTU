...
BeginPackage["GeneratorPlaneGraphDirectedEasy`"]
...
If[diff==="EASY",
n=RandomInteger[{7, 10}];
edgesNumber=RandomInteger[{10, 15}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] Plane (lietadlov\[YAcute]) graf n\[AAcute]ro\[CHacek]nos\[THacek] EASY**)
