...
BeginPackage["GeneratorPizzaGraphDirectedMedium`"]
Equation::usage = "Equation[difficulty] generates a Pizza graph problem with solution steps and final result.";
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] Pizzov\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
