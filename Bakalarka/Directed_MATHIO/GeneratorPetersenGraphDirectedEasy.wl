...
BeginPackage["GeneratorPetersenGraphDirectedEasy`"]
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] Petersenov graf n\[AAcute]ro\[CHacek]nos\[THacek] EASY**)
