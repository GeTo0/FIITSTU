...
BeginPackage["GeneratorDodecahedronGraphDirectedMedium`"]
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] dodecahedron graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
