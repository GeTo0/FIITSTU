...
BeginPackage["GeneratorRandomGraphDirectedMedium`"]
...
edgesNumber=RandomInteger[{17, 25}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] n\[AAcute]hodn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
