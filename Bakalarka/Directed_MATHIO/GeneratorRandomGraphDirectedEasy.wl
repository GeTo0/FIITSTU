...
BeginPackage["GeneratorRandomGraphDirectedEasy`"]
...
If[diff==="EASY",
n=RandomInteger[{6, 9}];
edgesNumber=RandomInteger[{12, 16}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na orientovan\[YAcute] n\[AAcute]hodn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] EASY**)
