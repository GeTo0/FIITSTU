...
BeginPackage["GeneratorPizzaGraph`"]
Equation::usage = "Equation[difficulty,directed] generates a Pizza graph problem with solution steps and final result.";
...
If[diff===HARD,
n=Input["Enter number of vertexes (15 recommended)"];
];
