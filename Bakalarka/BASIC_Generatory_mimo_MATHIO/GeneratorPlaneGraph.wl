...
edgesNumber=Input["Enter number of vertexes (12 recommended)"];
];
If[diff===MEDIUM,
n=Input["Enter number of vertexes (10 recommended)"];
edgesNumber=Input["Enter number of vertexes (18 recommended)"];
];
If[diff===HARD,
n=Input["Enter number of vertexes (14 recommended)"];
edgesNumber=Input["Enter number of vertexes (25 recommended)"];
];
