...
BeginPackage["GeneratorSquareGraphUndirectedHard`"]
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] \[SHacek]tvorcov\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] HARD**)
