...
BeginPackage["GeneratorPizzaGraphUndirectedMedium`"]
Equation::usage = "Equation[difficulty,directed] generates a Pizza-looking graph problem with solution steps and final result.";
...
(**TVORBA PIZZOV\[CapitalEAcute]HO GRAFU**)
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] Pizzov\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
...
directed=False;
{mygraph,edges,weights,edgeLabels,vertexABC,n}=makePizzaGraph[difficulty, directed];
vertexPositions = GraphEmbedding[mygraph];
