...
BeginPackage["GeneratorRandomGraphUndirectedMedium`"]
Equation::usage = "Equation[difficulty] generates a Random graph problem with solution steps and final result.";
...
(**TVORBA N\[CapitalAAcute]HODN\[CapitalEAcute]HO GRAFU**)
...
If[diff==="MEDIUM",
n=RandomInteger[{10, 14}];
edgesNumber=RandomInteger[{14, 21}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] n\[AAcute]hodn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
