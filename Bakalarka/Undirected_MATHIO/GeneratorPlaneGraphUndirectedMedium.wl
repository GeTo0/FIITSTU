...
BeginPackage["GeneratorPlaneGraphUndirectedMedium`"]
...
(**TVORBA PLANE (LIETADLOVEHO) GRAFU**)
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] plane (lietadlov\[YAcute]) graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
