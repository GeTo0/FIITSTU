...
BeginPackage["GeneratorBipartiteGraphUndirectedMedium`"]
Equation::usage = "Equation[difficulty] generates a Bipartite graph problem with solution steps and final result.";
...
(**TVORBA BIPARTITN\[CapitalEAcute]HO GRAFU**)
...
If[diff==="MEDIUM",
n = 2 * RandomInteger[{4, 5}];
edgesNumber = 2 * RandomInteger[{8, 10}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] bipartitn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
