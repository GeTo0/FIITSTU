...
BeginPackage["GeneratorDiamondGraphUndirectedHard`"]
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] "diamantov\[YAcute]" graf n\[AAcute]ro\[CHacek]nos\[THacek] HARD**)
