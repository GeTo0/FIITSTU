...
BeginPackage["GeneratorBipartiteGraphUndirectedEasy`"]
...
If[diff==="EASY",
n = 2 * RandomInteger[{3, 4}];
edgesNumber = 2 * RandomInteger[{6, 8}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] bipartitn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] EASY**)
