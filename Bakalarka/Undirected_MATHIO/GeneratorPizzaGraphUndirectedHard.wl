...
BeginPackage["GeneratorPizzaGraphUndirectedHard`"]
Equation::usage = "Equation[difficulty] generates a Pizza-looking graph problem with solution steps and final result.";
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] Pizzov\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] HARD**)
