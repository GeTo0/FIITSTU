...
BeginPackage["GeneratorDiamondGraphUndirectedMedium`"]
Equation::usage = "Equation[difficulty] generates a Diamond-looking graph problem with solution steps and final result.";
...
(**TVORBA DIAMANTOV\[CapitalEAcute]HO GRAFU**)
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] "diamantov\[YAcute]" graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
