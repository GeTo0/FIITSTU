...
BeginPackage["GeneratorPlaneGraphUndirectedHard`"]
...
If[diff==="HARD",
n=RandomInteger[{16, 22}];
edgesNumber=RandomInteger[{20, 32}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] plane (lietadlov\[YAcute]) graf n\[AAcute]ro\[CHacek]nos\[THacek] HARD**)
