...
BeginPackage["GeneratorSquareGraphUndirectedMedium`"]
Equation::usage = "Equation[difficulty] generates a Square-like graph problem with solution steps and final result.";
...
(**TVORBA \[CapitalSHacek]TVORCOV\[CapitalEAcute]HO GRAFU**)
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] \[SHacek]tvorcov\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
