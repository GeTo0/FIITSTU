...
BeginPackage["GeneratorPetersenGraphUndirectedEasy`"]
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] Petersenov graf n\[AAcute]ro\[CHacek]nos\[THacek] EASY**)
