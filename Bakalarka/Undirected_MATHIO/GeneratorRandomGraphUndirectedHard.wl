...
BeginPackage["GeneratorRandomGraphUndirectedHard`"]
...
If[diff==="HARD",
n=RandomInteger[{15, 20}];
edgesNumber=RandomInteger[{22, 36}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] n\[AAcute]hodn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] HARD**)
