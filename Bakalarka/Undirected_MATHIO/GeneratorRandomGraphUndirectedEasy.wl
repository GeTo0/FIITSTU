...
BeginPackage["GeneratorRandomGraphUndirectedEasy`"]
...
If[diff==="EASY",
n=RandomInteger[{6, 9}];
edgesNumber=RandomInteger[{10, 14}];
];
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] n\[AAcute]hodn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] EASY**)
