...
BeginPackage["GeneratorCompleteGraphUndirectedMedium`"]
Equation::usage = "Equation[difficulty] generates a Complete graph problem with solution steps and final result.";
...
(**ZADANIE**)
(**Tento s\[UAcute]bor je ur\[CHacek]en\[YAcute] IBA na neorientovan\[YAcute] kompletn\[YAcute] graf n\[AAcute]ro\[CHacek]nos\[THacek] MEDIUM**)
