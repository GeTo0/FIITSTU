...
Equation[difficulty_,directed_] := Module[{solution, mygraph, edges, weights, vertexABC, vertexCount,operations,
answer, problemText,graphProblem,problem,graphCell,vertexWeights},
